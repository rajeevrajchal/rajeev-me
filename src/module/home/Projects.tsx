...
const Projects = () => (
  <div>
    <div className="flex justify-between items-center">
      ...
      <Link href={AppRoute.PROJECT} passHref>
    ...
    <Spacer />
    <div className="grid gap-8 grid-cols-1 lg:grid-cols-2 grid-rows-auto">
      {[1, 2, 3].map(() => (
        <div className="h-[38vh] lg:h-[38vh] rounded-lg p-8 overflow-hidden relative card drop-shadow-xl bg-base-100">
          ...
          <div className="w-2 h-[50vh] lg:h-[38vh] bg-blue-300 absolute top-0 left-0" />
        </div>
      ))}
    </div>
  </div>
